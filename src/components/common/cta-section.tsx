    ...
    <section className="relative overflow-hidden py-20 md:py-28">
      ...
      <div className="container mx-auto max-w-5xl px-4">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.6 }} className="text-center text-white">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-white/80 md:text-lg">Join 12,500+ aspirants who chose Alia Academy to take the disciplined route to a commissioned career.</p>
